...
// and API share an origin exactly like production (kbrelay.com
// serves the SPA; kbrelay.com/api/* is the Worker route).
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // production `kbrelay.com/docs` route. Prefix match is fine —
